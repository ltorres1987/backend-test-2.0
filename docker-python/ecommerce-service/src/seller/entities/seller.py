...
class Seller:
    ...
    def __init__(
            self, id, name, short_description, seller_user, address, created_at=None, updated_at=None, deleted_at=None
    ):
    ...
    def from_dict(cls, dict):
        ...
        return Seller(id, name, short_description, seller_user, address, created_at, updated_at, deleted_at)
