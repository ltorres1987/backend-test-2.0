...
# Entidad representando a un SellOrderDetail.


class SellOrderDetail:

    def __init__(
            self, id, sell_order_id, sku, quantity, created_at=None, updated_at=None, deleted_at=None
    ):
        self.id = id
    ...
    def from_dict(cls, dict):
        ...
        id = dict.get("id")
        sell_order_id = dict.get("sell_order_id")
        sku = dict.get("sku")
        ...
        return SellOrderDetail(id, sell_order_id, sku, quantity, created_at, updated_at, deleted_at)
