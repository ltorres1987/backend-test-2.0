...
class Product:
    ...
    def __init__(
            self, id, name, short_description, quantity, seller_id, created_at=None, updated_at=None, deleted_at=None
    ):
        self.id = id
        self.name = name
    ...
    def from_dict(cls, dict):
        ...
        return Product(id, name, short_description, quantity, seller_id, created_at, updated_at, deleted_at)
