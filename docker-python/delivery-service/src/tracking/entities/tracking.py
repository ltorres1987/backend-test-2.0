...
# Entidad representando a un seller.


class Tracking:

    def __init__(
            self, id, shipping_order_id, date, status, created_at=None, updated_at=None, deleted_at=None
    ):
        self.id = id
    ...
    def from_dict(cls, dict):
        ...
        return Tracking(id, shipping_order_id, date, status, created_at, updated_at, deleted_at)
